...
//   // Crear conexión
  ...
  $sql = "UPDATE inmuebles SET nombre=$nombre, descripcion=$descripcion,tipo=$tipo, latitud=$latitud, longitud=$longitud, destacado=$destacado, foto=$foto, precio=$precio  WHERE id=$id";
 echo $sql;
